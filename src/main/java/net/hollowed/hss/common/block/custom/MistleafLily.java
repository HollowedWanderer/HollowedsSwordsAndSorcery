...
public class MistleafLily extends BushBlock implements SuspiciousEffectHolder {
    ...
    public MistleafLily(java.util.function.Supplier<MobEffect> effectSupplier, int p_53513_, BlockBehaviour.Properties p_53514_) {
        super(p_53514_);
    ...
    @Deprecated
    public MistleafLily(MobEffect p_53512_, int p_53513_, BlockBehaviour.Properties p_53514_) {
        super(p_53514_);
