...
public class DungeonDoorBlockEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar data) {
        data.add(new AnimationController<DungeonDoorBlockEntity>(this, "controller", 0, this::predicate));
        data.add(new AnimationController<DungeonDoorBlockEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
    }
    ...
    public Component getDefaultName() {
        return Component.literal("fancy_door");
    }
    ...
    public Component getDisplayName() {
        return Component.literal("Fancy Door");
    }
