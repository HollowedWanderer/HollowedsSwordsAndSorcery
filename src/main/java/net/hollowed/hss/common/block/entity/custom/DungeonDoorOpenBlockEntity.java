...
public class DungeonDoorOpenBlockEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
    private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

    public DungeonDoorOpenBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.DUNGEON_DOOR_OPEN.get(), pos, state);
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar data) {
        data.add(new AnimationController<DungeonDoorOpenBlockEntity>(this, "controller", 0, this::predicate));
        data.add(new AnimationController<DungeonDoorOpenBlockEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
    }
    ...
    public Component getDefaultName() {
        return Component.literal("fancy_door_open");
    }
    ...
    public Component getDisplayName() {
        return Component.literal("Fancy Door Open");
    }
