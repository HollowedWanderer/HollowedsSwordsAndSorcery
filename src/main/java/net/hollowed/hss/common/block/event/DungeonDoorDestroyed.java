...
public class DungeonDoorDestroyed {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == ModBlocks.DUNGEON_DOOR_HITBOX.get()
				|| (world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == ModBlocks.DUNGEON_DOOR_OPEN_HITBOX.get()) {
			{
		...
		if ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == ModBlocks.DUNGEON_DOOR_HITBOX.get()
				|| (world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == ModBlocks.DUNGEON_DOOR_OPEN_HITBOX.get()) {
			{
