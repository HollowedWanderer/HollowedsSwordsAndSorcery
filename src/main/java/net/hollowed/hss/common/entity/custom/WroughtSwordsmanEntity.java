...
public class WroughtSwordsmanEntity extends Monster implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public WroughtSwordsmanEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
