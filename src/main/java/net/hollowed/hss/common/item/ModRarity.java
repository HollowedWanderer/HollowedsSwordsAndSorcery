...
public enum ModRarity implements net.minecraftforge.common.IExtensibleEnum {
    ...
    public static net.minecraft.world.item.Rarity create(String name, ChatFormatting p_43028_) {
        throw new IllegalStateException("Enum not extended");
    }

    public static net.minecraft.world.item.Rarity create(String name, java.util.function.UnaryOperator<net.minecraft.network.chat.Style> styleModifier) {
        throw new IllegalStateException("Enum not extended");
    }
