...
import net.hollowed.hss.common.event.IceWandEvent;
...
/**        if (entity instanceof Player _player)
        ...
        if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ModItems.ICE_WAND.get()) {
            if (entity instanceof LivingEntity _entity)
                _entity.swing(InteractionHand.MAIN_HAND, true);
        } else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ModItems.ICE_WAND.get()) {
            if (entity instanceof LivingEntity _entity)
        ...
        if (world instanceof ServerLevel _level)
            _level.getServer().getCommands().performPrefixedCommand(
                    ...
                    "summon hss:ice_chunk ~ ~5 ~");
        IceWandEvent.execute(world, entity);
    }
}
