...
import net.hollowed.hss.common.item.ModArmorMaterials;
import net.hollowed.hss.common.item.client.SilverArmorRenderer;
import net.hollowed.hss.common.item.client.SteelArmorRenderer;
...
public class SilverArmorItem extends ArmorItem implements GeoItem {
    ...
    public SilverArmorItem(ArmorMaterial material, Type type, Properties properties) {
