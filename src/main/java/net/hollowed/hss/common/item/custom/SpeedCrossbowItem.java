...
public class SpeedCrossbowItem extends CrossbowItem {
    ...
    private static final float FIREWORK_POWER = 1.8F;

    public SpeedCrossbowItem(Item.Properties p_40850_) {
        super(p_40850_);
    }
    ...
    private static float getShootingPower(ItemStack p_40946_) {
        return containsChargedProjectile(p_40946_, Items.FIREWORK_ROCKET) ? 1.8F : 3.75F;
    }
