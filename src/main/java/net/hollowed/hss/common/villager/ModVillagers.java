...
public class ModVillagers {
    public static final DeferredRegister<PoiType> POI_TYPES =
            DeferredRegister.create(ForgeRegistries.POI_TYPES, HollowedsSwordsAndSorcery.MOD_ID);
    public static final DeferredRegister<VillagerProfession> VILLAGER_PROFESSIONS =
            DeferredRegister.create(ForgeRegistries.VILLAGER_PROFESSIONS, HollowedsSwordsAndSorcery.MOD_ID);

    public static final RegistryObject<PoiType> MINING_TABLE_POI = POI_TYPES.register("mining_table_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.MINING_TABLE.get().getStateDefinition().getPossibleStates()),
                    1,1));
